...
class DatabaseDataManager:
    ...
    def __init__(self, logger_name, db_host, db_username, db_password, db_name, db_classes_file_path=None):
        ...
        self.db_classes_file_path = db_classes_file_path
    ...
    def update_classes_file(self):
        if self.db_classes_file_path is not None:
            table_info = self.connector.get_table_information()
            self.file_manager.open(self.db_classes_file_path)
